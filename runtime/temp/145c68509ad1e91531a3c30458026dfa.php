<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"D:\phpStudy\www/application/admin\view\index\aboutedit.html";i:1500218442;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500451301;s:45:"./application/admin/view/index/page_menu.html";i:1500452421;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
...
<!-- end: Main Menu -->
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-tags"></i>修改文章</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="/admin/index/index/">首页</a></li>
						<li><i class="fa fa-list-alt"></i><a href="#">修改文章</a></li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-tags red"></i><strong>修改文章</strong></h2>
						</div>
							...
							<div id="wizard1" class="wizard-type1">
								...
								<script>
                                    ...
                                    app.controller('registerCtrl', function($scope) {
                                        $scope.AboutNamech = "<?php echo $AboutNamech; ?>";
                                        $scope.SeoKeywordsch = "<?php echo $SeoKeywordsch; ?>";
                                        $scope.SeoDescriptionch = "<?php echo $SeoDescriptionch; ?>";
                                        $scope.SunlyNetPic = "<?php echo $SunlyNetPic; ?>";
                                        $scope.Sequence = "<?php echo $Sequence; ?>";
                                    });
								</script>
								...
								<div class="tab-content">
								    <div class="tab-pane" style="display: block;">
											<div class="form-group">
							                    <label for="AboutNamech">标题</label>
												<input type="hidden" value="<?php echo $thisid; ?>" name="thisid" id="thisid">
												<input type="text" id="AboutNamech" name="AboutNamech" class="form-control" value="" ng-model="AboutNamech" required>
												<span style="color: red" ng-show="registerForm.AboutNamech.$invalid">
                                            <span ng-show="registerForm.AboutNamech.$error.required">*请输入标题</span>
							                </div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<select id="ParentID" name="ParentID" class="form-control">
												...
												<?php if(is_array($alist) || $alist instanceof \think\Collection || $alist instanceof \think\Paginator): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(($vo['ID']!=$thisid&&$vo['ParentID']!=$thisid)): ?>
												<option value="<?php echo $vo['ID']; ?>"<?php if(($ParentID==$vo['ID'])): ?> selected<?php endif; ?>><?php if($vo['Count'] == '2'): ?>-- <?php endif; if($vo['Count'] == '3'): ?>---- <?php endif; ?><?php echo $vo['AboutNamech']; ?></option>
												<?php endif; endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
										<div class="form-group">
											<label for="Contentch">内容</label>
											<textarea style="height: 300px;" id="Contentch" name="Contentch"><?php echo $Contentch; ?></textarea>
										...
										<div class="form-group">
											<label for="SunlyNetPic">图片</label>
											<input type="text" class="form-control" value="" name="SunlyNetPic" id="SunlyNetPic" placeholder="请上传图片..." ng-model="SunlyNetPic" required>
