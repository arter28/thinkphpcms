<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"D:\phpStudy\www/application/admin\view\product\sortedit.html";i:1500332662;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500083113;s:45:"./application/admin/view/index/page_menu.html";i:1500445347;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
...
<!-- end: Main Menu -->
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-tags"></i>修改分类</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="/admin/index/index/">首页</a></li>
						<li><i class="fa fa-th"></i><a href="#">产品管理</a></li>
						<li><i class="fa fa-sitemap"></i><a href="#">修改分类</a></li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-tags red"></i><strong>修改分类</strong></h2>
						</div>
							...
							<div id="wizard1" class="wizard-type1">
								...
								<script>
                                    ...
                                    app.controller('registerCtrl', function($scope) {
                                        $scope.SortNamech = "<?php echo $SortNamech; ?>";
								...
								<form class="form-horizontal" name="registerForm" method="post" action="/admin/product/savesortedit" novalidate>
								<div class="tab-content">
								    <div class="tab-pane" style="display: block;">
											<div class="form-group">
							                    <label for="SortNamech">标题</label>
												<input type="hidden" value="<?php echo $thisid; ?>" name="thisid" id="thisid">
												<input type="text" id="SortNamech" name="SortNamech" class="form-control" value="" ng-model="SortNamech" required>
												<span style="color: red" ng-show="registerForm.SortNamech.$invalid">
                                            <span ng-show="registerForm.SortNamech.$error.required">*请输入标题</span>
							                </div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<select id="ParentID" name="ParentID" class="form-control">
												...
												<option value="<?php echo $vo['ID']; ?>"<?php if(($ParentID==$vo['ID'])): ?> selected<?php endif; ?>><?php if($vo['Count'] == '2'): ?>-- <?php endif; if($vo['Count'] == '3'): ?>---- <?php endif; ?><?php echo $vo['SortNamech']; ?></option>
