<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:54:"D:\phpStudy\www/application/admin\view\news\index.html";i:1500448288;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500083113;s:45:"./application/admin/view/index/page_menu.html";i:1500445347;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
...
<!-- end: Main Menu -->
		...
		<!-- start: Content -->
			<div class="main sidebar-minified">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header"><i class="fa fa-table"></i>新闻管理</h3>
						<ol class="breadcrumb">
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>所有新闻</strong></h2>
								<div class="panel-actions">
									<a href="/admin/news/add"><i class="fa fa-plus"></i></a>
								</div>
							</div>
							<div class="panel-body">
								<table class="table">
									...
									<tr>
										...
										<td><img src="<?php echo $vo['SunlyNetPic']; ?>" height="80"></td>
										<td><?php echo $vo['NewsNamech']; ?></td>
										<td><?php echo $vo['AddTime']; ?></td>
										<td>
											<a href="/admin/news/edit/<?php echo $vo['ID']; ?>"><span class="label label-success">修改</span></a>
											<a href="/admin/news/del/<?php echo $vo['ID']; ?>" onclick='return confirm("真的要删除?不可恢复!");'><span class="label label-danger">删除</span></a>
										</td>
									</tr>
									<?php endforeach; endif; else: echo "" ;endif; ?>
									</tbody>
