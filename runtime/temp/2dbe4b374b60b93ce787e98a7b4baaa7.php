<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"D:\phpStudy\www/application/admin\view\news\edit.html";i:1500448230;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500083113;s:45:"./application/admin/view/index/page_menu.html";i:1500445347;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<!-- end: Main Menu -->
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-tags"></i>修改新闻</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="/admin/index/index/">首页</a></li>
						<li><i class="fa fa-th"></i><a href="/admin/news/index/">新闻管理</a></li>
						<li><i class="fa fa-list-alt"></i><a href="#">修改新闻</a></li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-tags red"></i><strong>添加新闻</strong></h2>
						</div>
                                            ...
                                            <span ng-show="registerForm.SeoDescriptionch.$error.required">*请输入描述</span>
												...
												<div class="form-group">
													...
													<select id="ParentID" name="SortID" class="form-control">
														...
														<option value="<?php echo $vo['ID']; ?>"<?php if(($SortID==$vo['ID'])): ?> selected<?php endif; ?>><?php if($vo['Count'] == '2'): ?>-- <?php endif; if($vo['Count'] == '3'): ?>---- <?php endif; ?><?php echo $vo['SortNamech']; ?></option>
														<?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group">
