<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"D:\phpStudy\www/application/admin\view\index\about.html";i:1500304076;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500451301;s:45:"./application/admin/view/index/page_menu.html";i:1500452421;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>所有文章</strong></h2>
								<div class="panel-actions">
									<a href="/admin/index/aboutadd"><i class="fa fa-plus"></i></a>
								</div>
							</div>
							<div class="panel-body">
								<table class="table">
									...
									<tr>
										...
										<td style="text-indent:<?php echo $vo['Count']*20; ?>px;"><?php if($vo['Count'] != '1'): ?>| -- <?php endif; ?><?php echo $vo['AboutNamech']; ?></td>
										<td><?php echo $vo['AddTime']; ?></td>
										<td>
											<a href="/admin/index/aboutedit/<?php echo $vo['ID']; ?>"><span class="label label-success">修改</span></a>
											<a href="/admin/index/aboutdel/<?php echo $vo['ID']; ?>" onclick='return confirm("真的要删除?不可恢复!");'><span class="label label-danger">删除</span></a>
										</td>
									</tr>
									<?php endforeach; endif; else: echo "" ;endif; ?>
									</tbody>
