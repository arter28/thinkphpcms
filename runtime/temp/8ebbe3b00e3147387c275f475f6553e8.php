<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"D:\phpStudy\www/application/admin\view\product\index.html";i:1500335263;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500083113;s:45:"./application/admin/view/index/page_menu.html";i:1500445347;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>所有产品</strong></h2>
							...
							<div class="panel-body">
								<table class="table">
									...
									<tr>
										...
										<td><img src="<?php echo $vo['SmallPic']; ?>" height="80"></td>
										<td><?php echo $vo['ProductNamech']; ?></td>
										<td><?php echo $vo['AddTime']; ?></td>
										<td>
											<a href="/admin/product/edit/<?php echo $vo['ID']; ?>"><span class="label label-success">修改</span></a>
											<a href="/admin/product/del/<?php echo $vo['ID']; ?>" onclick='return confirm("真的要删除?不可恢复!");'><span class="label label-danger">删除</span></a>
										</td>
									</tr>
									<?php endforeach; endif; else: echo "" ;endif; ?>
									</tbody>
