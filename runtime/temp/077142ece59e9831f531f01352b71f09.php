<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"D:\phpStudy\www/application/admin\view\product\sort.html";i:1500331976;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500083113;s:45:"./application/admin/view/index/page_menu.html";i:1500445347;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<div class="panel-actions">
									<a href="/admin/product/sortadd"><i class="fa fa-plus"></i></a>
								</div>
							</div>
							<div class="panel-body">
								<table class="table">
									...
									<tr>
										...
										<td>
											<a href="/admin/product/sortedit/<?php echo $vo['ID']; ?>"><span class="label label-success">修改</span></a>
											<a href="/admin/product/sortdel/<?php echo $vo['ID']; ?>" onclick='return confirm("真的要删除?不可恢复!");'><span class="label label-danger">删除</span></a>
										</td>
									</tr>
									<?php endforeach; endif; else: echo "" ;endif; ?>
									</tbody>
