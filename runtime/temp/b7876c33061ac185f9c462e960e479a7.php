<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\phpStudy\www/application/admin\view\index\aboutadd.html";i:1500304357;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500451301;s:45:"./application/admin/view/index/page_menu.html";i:1500452421;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
...
<!-- end: Main Menu -->
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-tags"></i>添加文章</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="/admin/index/index/">首页</a></li>
						<li><i class="fa fa-list-alt"></i><a href="#">添加文章</a></li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-tags red"></i><strong>添加文章</strong></h2>
						</div>
						<div class="panel-body">
							...
							<div id="wizard1" class="wizard-type1">
								...
								<form class="form-horizontal" name="registerForm" method="post" action="/admin/index/saveaboutadd" novalidate>
								    ...
								    <div class="tab-pane" style="display: block;">
										...
										<div class="form-group">
											...
											<select id="ParentID" name="ParentID" class="form-control">
												...
												<option value="<?php echo $vo['ID']; ?>"><?php if($vo['Count'] == '2'): ?>-- <?php endif; if($vo['Count'] == '3'): ?>---- <?php endif; ?><?php echo $vo['AboutNamech']; ?></option>
												<?php endforeach; endif; else: echo "" ;endif; ?>
											</select>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="<?php echo $Sequence; ?>" name="Sequence" id="Sequence" placeholder="请输入排序号...">
										</div>
								    </div>
