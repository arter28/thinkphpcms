<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"D:\phpStudy\www/application/admin\view\index\message.html";i:1500450661;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500451301;s:45:"./application/admin/view/index/page_menu.html";i:1500452421;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
...
<!-- end: Main Menu -->
		...
		<!-- start: Content -->
			<div class="main sidebar-minified">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header"><i class="fa fa-table"></i>咨询反馈</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="/admin/index/index">首页</a></li>
							<li><i class="fa fa-th"></i>咨询反馈</li>
						</ol>
					</div>
				</div>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2><i class="fa fa-table red"></i><span class="break"></span><strong>所有留言</strong></h2>
							</div>
							<div class="panel-body">
								<table class="table">
									...
									<tr>
										...
										<td><?php echo $vo['MesName']; ?></td>
										<td><?php echo $vo['AddTime']; ?></td>
										<td>
											<?php if(($vo['ViewFlagch'])): ?>
											<a href="/admin/index/messageview/<?php echo $vo['ID']; ?>"><span class="label label-success">已读</span></a>
											<?php else: ?>
											<a href="/admin/index/messageview/<?php echo $vo['ID']; ?>"><span class="label label-primary">未读</span></a>
											<?php endif; ?>
											<a href="/admin/index/messagedel/<?php echo $vo['ID']; ?>" onclick='return confirm("真的要删除?不可恢复!");'><span class="label label-danger">删除</span></a>
										</td>
									</tr>
									<?php endforeach; endif; else: echo "" ;endif; ?>
									</tbody>
								</table>
								<div style="width:100%; display:table;"><center><?php echo $alist->render(); ?></center></div>
							</div>
						</div>
					</div><!--/col-->
				</div><!--/row-->
