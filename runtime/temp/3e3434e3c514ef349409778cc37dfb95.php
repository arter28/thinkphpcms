<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"D:\phpStudy\www/application/admin\view\product\add.html";i:1500443372;s:51:"./application/admin/view/index/page_googlefont.html";i:1500082899;s:44:"./application/admin/view/index/page_top.html";i:1500083113;s:45:"./application/admin/view/index/page_menu.html";i:1500445347;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
    	<meta charset="utf-8">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="wizard1" class="wizard-type1">
								...
								<form class="form-horizontal" name="registerForm" method="post" action="/admin/product/saveadd" novalidate>
								<div class="tab-content">
								    <div class="tab-pane" style="display: block;">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="" name="SmallPic" id="SmallPic" placeholder="请上传图片...">
											<input type="button" id="uploadButton" value="上传图片..."/>
										</div>
										<div class="form-group">
											<label for="BigPic">主图</label>
											<input type="text" class="form-control" value="" name="BigPic" id="BigPic" placeholder="请上传图片...">
